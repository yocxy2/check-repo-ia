...
export default function InputSearch({ onSearch, loading, ...rest}: InputSearchProps) {
    ...
    return <form className="flex flex-col gap-0 w-full">
        <span className="text-slate-400 border border-indigo-600 bg-white rounded overflow-hidden py-1 px-2 flex flex-row gap-1 justify-between">
            <input type="text" className="w-full border-none outline-none" {...rest} />
